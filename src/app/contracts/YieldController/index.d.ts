...
export type SupportedYieldType = {
    tag: "Lending";
    values: void;
} | {
    tag: "Liquidity";
...
export interface Client {
     ...
     */
    deposit_collateral: ({ protocol, user, asset, amount }: {
        protocol: string;
        user: string;
        asset: string;
        amount: i128;
     ...
     */
    withdraw_collateral: ({ protocol, user, asset, amount }: {
        protocol: string;
        user: string;
        asset: string;
        amount: i128;
     ...
     */
    set_yield_distributor: ({ yield_distributor }: {
     ...
     */
    set_adapter_registry: ({ adapter_registry }: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        withdraw_collateral: (json: string) => AssembledTransaction<bigint>;
        get_yield: (json: string) => AssembledTransaction<bigint>;
        claim_yield: (json: string) => AssembledTransaction<bigint>;
        set_yield_distributor: (json: string) => AssembledTransaction<null>;
        set_adapter_registry: (json: string) => AssembledTransaction<null>;
        set_cusd_manager: (json: string) => AssembledTransaction<null>;
        get_yield_distributor: (json: string) => AssembledTransaction<string>;
        get_adapter_registry: (json: string) => AssembledTransaction<string>;
        get_cusd_manager: (json: string) => AssembledTransaction<string>;
